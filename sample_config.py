...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/PASHAGDU/NEXT3"
    )
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/PASHAGDU/ZED_USERBOT")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/PASHAGDU/ZED_USERBOT"
    OLDZED_REPOBRANCH = os.environ.get("OLDZED_REPOBRANCH", "oldzed")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/PASHAGDU/ZVCPlayer")
